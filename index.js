(function(global) {
  ...
  function cube(){
    ...
    var CubeVertices = [
      ...
      // ABCD
      -0.375, -0.75, 0.45,    1.0, 1.0, 1.0,    //A
      -0.375, 0.75, 0.45,     1.0, 1.0, 1.0,    //B
      -0.375, 0.75, 0.45,     1.0, 1.0, 1.0,    //B
      0.375, 0.75, 0.45,      1.0, 1.0, 1.0,    //C

      0.375, 0.75, 0.45,      1.0, 1.0, 1.0,    //C
      0.375, -0.75, 0.45,     1.0, 1.0, 1.0,    //D
      0.375, -0.75, 0.45,     1.0, 1.0, 1.0,    //D
      -0.375, -0.75, 0.45,    1.0, 1.0, 1.0,    //A
      
      //DCGH
      0.375, 0.75, 0.45,      1.0, 1.0, 1.0,    //C
      0.375, 0.75, -0.45,     1.0, 1.0, 1.0,    //G
      0.375, -0.75, 0.45,     1.0, 1.0, 1.0,    //D
      0.375, -0.75, -0.45,    1.0, 1.0, 1.0,    //H

      //ABFE
      -0.375, -0.75, 0.45,    1.0, 1.0, 1.0,    //A
      -0.375, -0.75, -0.45,   1.0, 1.0, 1.0,    //E
      -0.375, 0.75, 0.45,     1.0, 1.0, 1.0,    //B
      -0.375, 0.75, -0.45,    1.0, 1.0, 1.0,    //F
  ...
  function triangle(){
    ...
    var triangleVertices = [
      ...
      +0.3, +0.5, 0.50, 0.50, 0.50,
      +0.3, +0.3, 0.50, 0.50, 0.50,
      +0.6, +0.5, 0.50, 0.50, 0.50,
      +0.55, +0.3, 0.50, 0.50, 0.50,
